...
import image from "../../../../Assets/Banners/banner-2.webp"
...
export default function ProductDetails() {
    ...
    useEffect(() => {
        ...
        if(product) {
            const main = new Splide('#main-slider', {
                ...
                breakpoints: {
                    1024: {
                        height: '400px',   // smaller on tablets
                    },
                    850: {
    ...
    return (
        <section>
            <div className="product-details-section common-padding">
                        ...
                        <div className="stock-available-div">
                            {product.isAvailable ? (
                                <div className="stock-available">
                                    <GoDotFill /> <span>Available</span>
                                </div>
                            ) : (
                                <div className="no-stock">
                                    <GoDotFill /> <span>Not Available</span>
                                </div>
                            )}
                        </div>
